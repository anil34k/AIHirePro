...
class InterviewSchedule(models.Model):
    ...
    job = models.ForeignKey(Job, on_delete=models.CASCADE, related_name='interview_schedules')
    ...
    def __str__(self):
        return f"Interview on {self.scheduled_time.strftime('%Y-%m-%d %H:%M')} for {self.candidate.username}"
